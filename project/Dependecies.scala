...
object Dependecies {
  ...
  lazy val cucumberVersion = "8.23.1"
  /*
   * Libraries
   */
  val cucumberCore = "io.cucumber" % "cucumber-core" % "7.18.1" % Test
  val cucumberJunit =
  ...
  val scalaTestJUnit5 =
    "org.scalatestplus" %% "junit-5-10" % "3.2.19.0" % Test
  val mockitoCore = "org.mockito" % "mockito-core" % "5.12.0" % Test
